        ...
        <div className='w-[20%]'>
            <div>
                ...
                <div className='my-4'>
                    ...
                    <Link to={`/batches`} className='flex items-center my-2 px-4 py-2 hover:bg-gray-200 hover:cursor-pointer rounded-full'>
                        <div>
                            <SiGoogleclassroom size="24px"/>
                        </div>
                        <h1 className='font-bold text-lg ml-2'>Batches</h1>
                    </Link>
                    ...
                    <Link to={'/contactme'} className='flex items-center my-2 px-4 py-2 hover:bg-gray-200 hover:cursor-pointer rounded-full'>
                        <div>
                        <IoIosContact size="24px" />
                        </div>
                        <h1 className='font-bold text-lg ml-2'>Contact Me</h1>
                    </Link>
