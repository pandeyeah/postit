  ...
  return (
    <div className='w-screen h-screen flex items-center justify-center'>
      <div className='flex items-center justify-evenly w-[80%]'>
        ...
        <div>
          <div className='my-5'>
            <h1 className='font-bold text-4xl'>Clear your</h1>
            <h1 className='font-bold text-4xl'>DOUBTs now.</h1>
          </div>
          <h1 className='mt-4 mb-2 text-gray-500 text-xl font-bold'>{isLogin ? "Login" : "Singup"}</h1>
          <form onSubmit={submitHandler} className='flex flex-col w-[95%]'>
            {
              !isLogin && (<>
            ...
            <button className='bg-[#000] border-none py-2 my-4 rounded-full text-lg text-white'>{isLogin ? "Login" : "Create Account"}</button>
